...
├── TEST_CASES.md             # Test scenarios (TC-01 – TC-08)
└── README.md                 # This file
```
...
See [TEST_CASES.md](TEST_CASES.md) for the full set of test scenarios (TC-01 through TC-08) covering basic connectivity, access control enforcement, bulk load testing, and timeout behaviour.
