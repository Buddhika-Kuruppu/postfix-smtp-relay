...
See [MONITORING.md](MONITORING.md) for full details on log management and message queue management, including live log streaming, filtering by time, analysing delivery status, and queue inspection and control commands.
...
- See [MONITORING.md](MONITORING.md) for full queue commands
...
For log commands and queue management see [MONITORING.md](MONITORING.md).
